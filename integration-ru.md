...
`desc` - короткое описание предмета. _К примеру, "Реликвия древнерусских войнов, канувшая в летах"_.  
`pic` - ссылка на картинку предмета.  
`misc` - словарь с остальными данными, характеристиками предмета. _К примеру:_  

```json
{
    "name": "Меч-кладенец",
    "desc": "Реликвия древнерусских войнов, канувшая в летах",
    "pic" : "some_url.com/kladenec.png",
    "misc" :  {
        "damage": 100,
        "initiative": 100,
        "rarity": "legendary"
...
Данные в `misc` могут быть использованы для фильтрации и поиска товаров в аукционе.
