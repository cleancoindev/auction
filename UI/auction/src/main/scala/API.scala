...
class API(implicit system: ActorSystem,
  ...
  def testAsset: Int32 => Future[Either[String, GameItem]] = apiHelper.apiGetClass1[Int32, GameItem](address = "fb75559bb4bb172ca0795e50b390109a50ce794466a14c24c73acdb40604065b", methodName = "testAsset")
}
